                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="../makanan/hal_makanan.php">Daftar Makanan</a>
                                        </li>
                                        <li class="nav-item">
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"></li>Update Data Makanan
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <form action="process/hal_makanan.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-xl-3">
                                <div class="card">
                                    <h5 class="card-header">Gambar Makanan</h5>
                                    <div class="card-body">
                            ...
                            <div class="col-xl-9">
                                <div class="card">
                                    <h5 class="card-header">Makanan</h5>
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">ID Makanan</label>
                                            <div class="col-md-9">
                                                <input type="text" name="id_makanan" class="form-control" value="<?php echo $id_makanan ?>"
                                                    readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="nama_makanan" class="form-control" placeholder="Nama Makanan"
                                                    value="<?php echo $item['nama_makanan'] ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-5">
                                            <div class="col-md-6">
                                                <a name="backBtn" id="backBtn" class="btn btn-dark btn-block btn-lg"
                                                    href="hal_makanan.php" role="button">Kembali</a>
                                            </div>
